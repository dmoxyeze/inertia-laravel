          ...
          <table class="table-fixed w-full">
            ...
            <tbody>
              <template v-if="data.posts">
                  <tr v-for="row in data.posts" :key="row.id">
                    ...
                    <div class="">
                      ...
                      <div class="mb-4">
                        <label
                          ...
                          >Category:</label
                        >
                        <select name="" v-model="postForm.category" id="">
                          <option
                          v-for="(category, index) in data.categories"
                          :key="category.id" :value="category.id"
                          :selected="postForm.category == category.id"
                          >
                            {{ category.name }}
                            </option>
                        </select>
                        <div v-if="$page.props.errors.category" class="text-red-500">
                          {{ $page.props.errors.category[0] }}
                        </div>
                      </div>
                      <div class="mb-4">
                        <label
...
export default {
  ...
  methods: {
    ...
    deleteRow: function (data) {
      ...
      data._method = "DELETE";
      this.$inertia.delete("/posts/" + data.id, data);
      this.reset();
      this.closeModal();
    },
  },
